...
DIR = 'runs/experiment_5_teleconnections_complex/run'
if (!dir.exists(DIR)) {
...
if (FALSE){
  ...
  file_path <- file.path("runs/experiment_5_teleconnections_complex/run/", basename(file_name))
