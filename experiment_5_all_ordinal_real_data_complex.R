...
DIR = 'runs/experiment_5_all_ordinal_real_data_complex/run'
if (!dir.exists(DIR)) {
  dir.create(DIR, recursive = TRUE)
}
# Copy this file to the directory DIR
file.copy('/experiment_5_all_ordinal_real_data_complex.R', file.path(DIR, 'experiment_5_all_ordinal_real_data_complex.R'), overwrite=TRUE)
