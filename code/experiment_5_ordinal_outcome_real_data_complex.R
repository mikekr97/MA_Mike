...
DIR = 'runs/experiment_5_ordinal_outcome_real_data_complex/run'
if (!dir.exists(DIR)) {
  dir.create(DIR, recursive = TRUE)
}
# Copy this file to the directory DIR
file.copy('/experiment_5_ordinal_outcome_real_data_complex.R', file.path(DIR, 'experiment_5_ordinal_outcome_real_data_complex.R'), overwrite=TRUE)
...
param_model$evaluate(x = train$df_orig, y=train$df_orig, batch_size = 7L) # 6.29
summary(param_model)
