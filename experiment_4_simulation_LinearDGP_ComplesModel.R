...
DIR = 'runs/experiment_4_simulation_LinearDGP_ComplexModel/run'
if (!dir.exists(DIR)) {
  dir.create(DIR, recursive = TRUE)
}
# Copy this file to the directory DIR
file.copy('MA_Mike/experiment_4_simulation_LinearDGP_ComplexModel.R', file.path(DIR, 'experiment_4_simulation_LinearDGP_ComplexModel.R'), overwrite=TRUE)
...
if (FALSE){
  ...
  file_path <- file.path("runs/experiment_4_simulation_LinearDGP_ComplexModel/run/", basename(file_name))
