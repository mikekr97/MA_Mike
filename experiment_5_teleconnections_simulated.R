...
DIR = 'runs/experiment_5_teleconnections_simulated/run'
if (!dir.exists(DIR)) {
...
# generate data
# train = dgp(56, seed=ifelse(SEED > 0, SEED, -1))
# test  = dgp(14, seed=ifelse(SEED > 0, SEED + 1, -1))
...
if (FALSE){
  ...
  file_path <- file.path("runs/experiment_5_teleconnections_simulated/run/", basename(file_name))
